...
class TestInvalitlogin():
  ...
  def test_invalitlogin(self):
    self.driver.get("https://www.saucedemo.com/") # globalConstants veriyi çekiyoruz 
    self.driver.maximize_window()
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"username\"]").click()
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"username\"]").send_keys("s")
